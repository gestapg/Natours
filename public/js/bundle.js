...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZ2VzdGFwZyIsImEiOiJja3ZucDAydGgxYWI3MnBrbHA3NnlwemUwIn0.iGLh8rhFbjwtW3fpCGsr8A';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/gestapg/ckvnqfhoj4yzr15nziu4bh6hn',
    scrollZoom: false // center: [-118.22529693740044, 34.1015864026696],
    // zoom: 10,
    // interactive: false
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            showAllert('error', 'Error logging out! Try again.');
...
var stripe = Stripe('pk_test_51JtCWHLCjG2XRsyLIi3CoyStWF4khMFzhNoZcbL6GGEb4c6b9Db3bxy0b2scaokvrtPXjtAkAjyvVR2ZTVfWfi3p00E5AZBQbZ');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // 2) Create chechkout dorm + charge credit card
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "62094" + '/');
